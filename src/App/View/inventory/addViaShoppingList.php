    ...
    <div class="row justify-content-center">
        <form action="" class="col-md-6 col-xl-5" method="post">
            ...
            <div class="input-group mt-3">
                <input type="number" class="form-control" name="req_quantity" id="req_quantity" min="0" max="1000000" placeholder="Szükséges mennyiség" required>
            ...
            <p>
                Az "alapvető"-nek jelölt termékek autómatikusan felkerülnek a bevásárlólistára ha kevesebb van belöllük az elvárt minimális értéknél.
            </p>
